<template>
	<Layout>
		<div class="content">
			<h1>Hello friends!</h1>
			<p>Thank you all for lending your ears. I know I’m quite vocal on social media. It’s always a struggle to find a balance between the words that I say and the words I leave in my head.</p>
